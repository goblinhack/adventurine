                                            ...
                                            uint32_t button)
{
    ...
    int item = (typeof(item)) (uintptr_t) wid_get_context2(w);
    int col = (typeof(col)) (uintptr_t) wid_get_context3(w);
               ...
               int items, ...)
{
    ...
    for (i = 0; i < ctx->items; i++) {
        ...
        for (c = 0; c < cols; c++) {
            ...
            wid_set_context3(b, (void*) (uintptr_t) c);
            ...
            if (text) {
                if (!strncmp(text, "bar:", 3)) {
                    ...
                    wid_set_context3(bar, (void*) (uintptr_t) c);
